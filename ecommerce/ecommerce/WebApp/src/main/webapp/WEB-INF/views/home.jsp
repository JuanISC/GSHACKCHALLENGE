...
ya que éste sitio web solo es para efectos de pruebas en demo.
...
<html>
<head>
<title>Artículos novedosos</title>
<meta charset="utf-8">
...
// 		    	if(respuesta.code== 0){
			    	BootstrapDialog.show({
			            message: 'Compra autorizada con éxito',
			            buttons: [{
			                label: 'Cerrar',
...
// 				    BootstrapDialog.show({
// 			            message: 'Compra no fué autorizada por el usuario',
// 			            buttons: [{
// 			                label: 'Cerrar'
	// 		                action: function(dialogItself){
	// 		                    dialogItself.close();
